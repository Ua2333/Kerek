...
### User Agent
ua_xiaomi  = 'Mozilla/5.0 (Linux; Android 11; RMX2061 Build/RKQ1.201112.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5481.154 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/404.0.0.35.70;]'
...
def banner():
    ...
    _logo_line_3_ = ('%s / _// / / __/ -_)   / /   ║  %sCoded By fufuuuuuu AR  %s║'%(O,P,O))
    _logo_line_4_ = ('%s/___/_/_/\__/\__/  _/ /_   ║    %s• 🥲🥲🥲🥲🥲🥲 •    %s║'%(O,P,O))
